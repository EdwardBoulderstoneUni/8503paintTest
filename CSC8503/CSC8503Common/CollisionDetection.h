...
namespace NCL {
	...
	public:
		...
		static bool AABBCapsuleIntersection(const AABBVolume& volumeB, const Transform& worldTransformB,
		...
		//One OBB SAT Way
		static Vector3 FindBestTwoPointsOnLine(Vector3 point1,Vector3 point2,Vector3 plane);
