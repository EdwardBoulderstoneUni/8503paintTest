...
void TestPushdownAutomata(Window* w,TutorialGame* game) {
	PushdownMachine machine(new GameMenu(game));
...
int main() {
	...
	TestPathfinding();
	DisplayPathfinding();
	GameObject* testAIObject = g->GetAIObject_Enemy();
